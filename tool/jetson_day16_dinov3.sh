...
log "Jetson day-16 strict reproduction started"
...
if [[ "$RUN_SMOKE" == "1" ]]; then
  log "Running DinoV3-base (all tricks+Circle 256x128) smoke test with timeout=${SMOKE_TIMEOUT}s"
  set +e
...
log "Day-16 strict reproduction completed"
