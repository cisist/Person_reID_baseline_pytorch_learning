...
log "Jetson day-6 strict reproduction started"
...
log "README reference: python train.py --train_all --name res-usam --usam; python test.py --name res-usam"
...
log "Day-6 strict reproduction completed"
