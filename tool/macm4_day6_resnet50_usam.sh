...
TRAIN_NAME="${TRAIN_NAME:-macm4_day6_resnet50_usam}"
...
LOG_DIR="${LOG_DIR:-$ROOT_DIR/logs/macm4_day6}"
...
log "macm4 day-6 ResNet-50 + USAM strategy started"
...
if [[ "$RUN_FORMAL_TRAIN" == "1" ]]; then
  log "Starting formal ResNet-50 + USAM training on macm4"
...
log "macm4 day-6 strategy completed"
