...
TRAIN_NAME="${TRAIN_NAME:-macm4_day2_resnet50}"
...
LOG_DIR="${LOG_DIR:-$ROOT_DIR/logs/macm4_day2}"
...
log "macm4 day-2 ResNet-50 strategy started"
...
if [[ "$RUN_FORMAL_TRAIN" == "1" ]]; then
  log "Starting formal ResNet-50 training on macm4"
...
log "macm4 day-2 strategy completed"
