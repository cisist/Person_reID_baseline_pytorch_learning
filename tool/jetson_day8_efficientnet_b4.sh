...
log "Jetson day-8 strict reproduction started"
...
log "README reference: python train.py --use_efficient --name eff; python test.py --name eff"
...
log "Day-8 strict reproduction completed"
