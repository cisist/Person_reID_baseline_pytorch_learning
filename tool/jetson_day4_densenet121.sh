...
log "Jetson day-4 strict reproduction started"
...
log "README reference: python train.py --name ft_net_dense --use_dense --train_all"
...
if [[ "$RUN_FORMAL_TRAIN" == "1" ]]; then
  log "Starting formal DenseNet-121 training"
...
log "Day-4 strict reproduction completed"
