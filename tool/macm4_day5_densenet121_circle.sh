...
TRAIN_NAME="${TRAIN_NAME:-macm4_day5_densenet121_circle}"
...
LOG_DIR="${LOG_DIR:-$ROOT_DIR/logs/macm4_day5}"
...
log "macm4 day-5 DenseNet-121 Circle strategy started"
...
if [[ "$RUN_FORMAL_TRAIN" == "1" ]]; then
  log "Starting formal DenseNet-121 Circle training on macm4"
...
log "macm4 day-5 strategy completed"
