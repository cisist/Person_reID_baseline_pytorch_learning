...
log "Jetson day-9 strict reproduction started"
...
log "README reference: python train.py --use_convnext --name convnext; python test.py --name convnext"
...
log "Day-9 strict reproduction completed"
