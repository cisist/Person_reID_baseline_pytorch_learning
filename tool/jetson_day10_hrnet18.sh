...
log "Jetson day-10 strict reproduction started"
...
log "README reference: python train.py --use_hr --name hr18; python test.py --name hr18"
...
log "Day-10 strict reproduction completed"
